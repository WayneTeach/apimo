                                ...
                                <div class="filters-qty">
                                    ...
                                    <?php if (in_array('number_of_bedrooms', $apimo_filter)) : ?>
                                        ...
                                        <div class="filter-item-qty apimo-archive-filter apimo_number_of_bedrooms" data-id="number_of_bedrooms">
                                            ...
                                            <div class="label"><?php _e('Baths', 'apimo'); ?></div>
        ...
        <section class="Content-wrapper apimo-content-wrapper">
            ...
            <div data-unique-id="<?php echo esc_attr($apimo_data_id); ?>" class="Product-wrapper Grid-wrapper apimo-property-wrapper <?php if ($attrs['grid'] == 'horizontal') {
                ...
                <div class="<?php if ($attrs['view'] == 'carousel') {
                            ...
                            } ?>" data-slide-to-desktop="<?php echo esc_attr($attrs['desktop']); ?>" data-slide-to-mobile="<?php echo esc_attr($attrs['mobile']); ?>" data-slide-to-tablate="<?php echo esc_attr($attrs['tablate']); ?>" data_id="<?php echo esc_attr($shortcode_id); ?>">
            ...
            <?php if ($attrs['no_of_post'] != '') : ?>





                <div class="apimo-archive-pagination-div" data-type="shortcode" data-unique-id="<?php echo esc_attr($apimo_data_id); ?>" data-max-page="<?php echo esc_attr($apimo_query->max_num_pages); ?>" data-post-per-page="<?php echo esc_attr($attrs['no_of_post']); ?>" data-current-page="1">
