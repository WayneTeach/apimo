...
if (isset($_POST['save_general_setting'])) {
    ...
    $style = filter_var_array($_POST['style'], FILTER_SANITIZE_STRING);
    ...
    $archive = array(
        ...
        'view_1' => filter_var_array($_POST['archive']['view_1'], FILTER_SANITIZE_STRING),
        'filter' => filter_var_array($_POST['archive']['filter'], FILTER_SANITIZE_STRING),
        ...
        'archive_display_option' => filter_var_array($_POST['archive']['archive_display_option'], FILTER_SANITIZE_STRING),
            ...
            <div class="apimo-block apimo_setting_section general-setting">
                ...
                <div class="apimo-block-body apimo-section-description">
                    ...
                    <div class="apimo-api-key-information">
                        ...
                        <div class="apimo-api-key-information-row-wrap"> <?php if (!empty($apimo_api_keys)):
                                ...
                                if ($data['key'] == '' && $data['company_id'] == '') {
                                    ...
                                    <div class="apimo-api-key-information-row">
                                        ...
                                        <div class="apimo-row apimo-row-v-center">
                                            ...
                                            <div class="apimo-col-3 col-btn"> <button type="button" class="apimo-remove-data"> <svg id="Modalità_Isolamento" data-name="Modalità Isolamento" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 408.61 408.8">
                                            ...
                                            <div class="apimo-col-3"> <label class="apimo-api-key-box"> <span><?php _e('Add your API key', 'apimo'); ?></span> <input type="text" name="inserisci_api_key[]" class="apimo-input_text" value="<?php echo esc_html($data['key']); ?>" /> </label> </div>

                                            <div class="apimo-col-3"> <label class="apimo-compnay-id-box"> <span class="apimo-general-setting-label"><?php _e('Company ID', 'apimo'); ?></span> <input type="text" name="apimo_company_id[]" class="apimo-input_text" value="<?php echo esc_html($data['company_id']); ?>" /> </label> </div>
                ...
                <div class="apimo-footer align-right apimo-api-information-save">
                    ...
                    <div class=""> <button type="button" class="button button-outline apimo-input_button " id="add_new_agency"><?php _e("Add new agency", 'apimo'); ?></button> <input type="button" name="check_api_key" value="<?php _e('Validate Key/Save', 'apimo'); ?>" class="button button-primary wt_iew_export_action_btn apimo-input_button" /> </div>
                ...
                <div class="apimo-api-key-information-row" id="apimo-api-key-information-row-clone" style="display:none">
                    ...
                    <div class="apimo-row apimo-row-v-center">
                        ...
                        <div class="apimo-col-3"> <label class="apimo-api-key-box"> <span><?php _e('Add your API key', 'apimo'); ?></span> <input type="text" name="inserisci_api_key[]" class="apimo-input_text" value="" /> </label> </div>

                        <div class="apimo-col-3"> <label class="apimo-compnay-id-box"> <span class="apimo-general-setting-label"><?php _e('Company ID', 'apimo'); ?></span> <input type="text" name="apimo_company_id[]" class="apimo-input_text" value="" /> </label> </div>
                    ...
                    <div class="apimo-row">
                        ...
                        <div class="apimo-col-4">
                            ...
                            <div class="apimo-block-info">
                                ...
                                <p><?php _e('Manage the slug of your custom post type "properties". <br>You can add your custom url for the Properties List and Detail Page:', 'apimo'); ?></p>
                        ...
                        <div class="apimo-col-4">
                            ...
                            <div class="apimo-block-label">
                                ...
                                <h5><?php _e('Color settings'); ?></h5>

                            </div>

                            <div class="apimo-block-info">

                                <p><?php _e('This style is general for all the pages regarding apimo plugin.'); ?></p>
                                ...
                                <div class="apimo-row">
                                    ...
                                    <div class="apimo-col-auto">
                                        ...
                                        <div class="aprimo-block-style-option">
                                            ...
                                            <p>Choose a color:</p> <label> <input type="text" class="apimo-color-picker-field" name="style[primary][color]" placeholder="<?php _e('Select Color', 'apimo'); ?>" value="<?php echo esc_html($apimo_style['primary']['color']); ?>"> </label>
                                    ...
                                    <div class="apimo-col-auto">
                                        ...
                                        <div class="aprimo-block-style-option">
                                            ...
                                            <p>Choose a color:</p> <label> <input type="text" class="apimo-color-picker-field" name="style[secondary][color]" placeholder="<?php _e('Select Color', 'apimo'); ?>" value="<?php echo esc_html($apimo_style['secondary']['color']); ?>"> </label>
                        ...
                        <div class="apimo-col-3">
                            ...
                            <div class="apimo-block-label">
                                ...
                                <h5><?php _e('Container Settings'); ?></h5>

                            </div>

                            <div class="apimo-block-info">

                                <p><?php _e('Set up the width of the container for apimo archive.'); ?></p>
                    ...
                    <div class="apimo-step-line">
                        ...
                        <div class="apimo-body-inner">
                            ...
                            <div class="apimo-block-info">
                                ...
                                <p>Choose the card type for the properties in the archive page:</p>
                        ...
                        <div class="apimo-body-inner">
                            ...
                            <div class="apimo-block-info">
                                ...
                                <p><?php _e('Choose the number of columns for each view of website:', 'apimo'); ?></p>
                        ...
                        <div class="apimo-row">
                            ...
                            <div class="apimo-col-6">
                                ...
                                <div class="apimo-block-label">
                                    ...
                                    <h5><?php _e('Meta fields - Apimo Cards'); ?></h5>
                            ...
                            <div class="apimo-col-6">
                                ...
                                <div class="apimo-block-info">
                                    ...
                                    <p><?php _e('Choose the area type value to show in your website:', 'apimo'); ?></p>
                            ...
                            <div class="apimo-col-6">
                                ...
                                <div class="apimo-block-info">
                                    ...
                                    <p><?php _e('Select this option for remove all the icon from the metas. This option will affect archive page and all shortcode.', 'apimo'); ?></p>
                ...
                <div class="apimo-block-body apimo-section-description">
                    ...
                    <div class="apimo-section-description">
                        ...
                        <div class="apimo-radiogroup"> <label class="apimo-type-radio">
                                ...
                                <div class="apimo-radio-container"> <input type="radio" name="apimo_style_pagina" id="apimo-pagina_style_1" value="pagina_style_1" <?php if ($apimo_style_pagina == 'pagina_style_1') {
                            ...
                            <?php /*                       <label class="apimo-type-radio">                            <div class="apimo-radio-container">                                <input type="radio" name="apimo_style_pagina" id="apimo-pagina_style_2" value="pagina_style_2" <?php if ($apimo_style_pagina == 'pagina_style_2') {                                                                                                                                    echo 'checked';                                                                                                                                } ?>>                                <label for="apimo-pagina_style_2">                                    <p><?php _e("Style 2", 'apimo'); ?></p>                                    <div class="apimo-radio-image">                                        <img src="<?php echo esc_url($apimo_url . 'assets/images/Vertical.png'); ?>">                                    </div>                                </label>                            </div>                        </label> */?> </div>
            ...
            <div class="apimo-block apimo-crea-shortcode">
                ...
                <div class="apimo-block-body">
                    ...
                    <div class="apimo-create-shortcode-popup" id="apimo-create-shortcode-popup" style="display:none">
                        ...
                        <div class="apimo-steps-titles"> <button type="button" class="apimo-step-title active" data-id="1">1</button> <button type="button" class="apimo-step-title" data-id="2">2</button> <button type="button" class="apimo-step-title" data-id="3">3</button> <button type="button" class="apimo-step-title" data-id="4">4</button> <button type="button" class="apimo-step-title" data-id="5">5</button> <button type="button" class="apimo-step-title" data-id="6">6</button> </div>
                        ...
                        <div class="apimo-step step-1 active" data-id="1">
                            ...
                            <div class="apimo-step-buttons"> <button type="button" class="button button-primary apimo-step-button apimo-step-next" data-id="2">Next</button> </div>
                        ...
                        <div class="apimo-step apimo-filter-step step-2" data-id="2">
                            ...
                            <div class="apimo-step-title-inner">
                                ...
                                <p><?php _e('You can enable filters and paging in the shortcode. Pay attention to the next step.'); ?>
                            ...
                            <div class="apimo-step-description">
                                ...
                                <div class="apimo-row center">
                                    ...
                                    <div class="apimo-col-6"> <label class="apimo-field checkbox-toggle"> <label class="apimo-title"><strong><?php _e('Enable filter', 'apimo'); ?></strong></label>
                                    ...
                                    <div class="apimo-col-6"> <label class="apimo-field checkbox-toggle"> <label class="apimo-title"><strong><?php _e('Enable pagination', 'apimo'); ?></strong></label>
                            ...
                            <div class="apimo-step-buttons"> <button type="button" class="button apimo-step-button apimo-step-previous" data-id="1">Previous</button> <button type="button" class="button button-primary apimo-step-button apimo-step-next" data-id="3">Next</button> </div>
                        ...
                        <div class="apimo-step step-3" data-id="3">
                                ...
                                <div style="display: block;" class="property-selection" data-id="specific">
                                    ...
                                    <div class="apimo-section-description" id="select_specific_property">
                                        ...
                                        <div class="apimo-radiogroup without-image">
                                            ...
                                            <div class="apimo-type-radio"> <input type="radio" class="apimo-product-selection-type" name="apimo_proprty_selection_types" value="filter" id="apimo-product-by-filter" checked> <label for="apimo-product-by-filter">

                                                    <div class="apimo-radio-image"></div> <span><?php _e('By Filter', 'apimo'); ?></span>

                                                </label> </div>

                                            <div class="apimo-type-radio"> <input type="radio" class="apimo-product-selection-type" name="apimo_proprty_selection_types" value="tags" id="apimo-product-by-tags"> <label for="apimo-product-by-tags">

                                                    <div class="apimo-radio-image"></div> <span><?php _e('By Tags', 'apimo'); ?></span>

                                                </label> </div>

                                            <div class="apimo-type-radio"> <input type="radio" class="apimo-product-selection-type" name="apimo_proprty_selection_types" value="property" id="apimo-product-by-manual-selection"> <label for="apimo-product-by-manual-selection">
                                        ...
                                        <div class="apimo-proprty-selection-types" data-id="apimo-product-by-filter" style="display: block;">
                                            ...
                                            <div class="apimo-filter-product-shortcode">
                                                ...
                                                <div class="apimo-filter-product-shortcode__inner-scroll">
                                                    ...
                                                    <div class="apimo-filter-product-shortcode-filter-input-container-accordion">
                                                        ...
                                                        <div data-id="apimo_shortcode_filter_subtype" class="apimo-filter-product-shortcode-filter-data-wrap">
                                                            ...
                                                            <div class="apimo_subtype_wrap"> <label class="apimo-archive-filter"> <?php _e('subtype', 'apimo') ?> </label> <select name="apimo_subtype" data-id="apimo_subtype" class="apimo_input apimo_filter_input apimo_input_select">
                                                                    ...
                                                                    <?php $terms_country = $terms = get_terms(array('taxonomy' => 'apimo_subtype', 'hide_empty' => false)); foreach ($terms_country as $term_country):
                                                    ...
                                                    <div class="apimo-filter-product-shortcode-filter-input-container-accordion">
                                                        ...
                                                        <div data-id="apimo_shortcode_filter_area" class="apimo-filter-product-shortcode-filter-data-wrap">
                                                            ...
                                                            <div class="apimo_location_wrap"> <label class="apimo-archive-filter"> <?php _e('Country', 'apimo') ?> </label> <select name="apimo_country" data-id="apimo_country" class="apimo_input apimo_filter_input apimo_input_select">
                                                                    ...
                                                                    <option value=""><?php _e('Select Country', 'apimo') ?></option> <?php $terms_country = $terms = get_terms(array('taxonomy' => 'country', 'hide_empty' => false)); foreach ($terms_country as $term_country): ?> <option value="<?php echo esc_attr($term_country->term_id); ?>"><?php echo esc_attr($term_country->name); ?></option> <?php endforeach; ?>
                                                            ...
                                                            <div class="apimo_location_wrap"> <label class="apimo-archive-filter"> <?php _e('Region', 'apimo') ?> </label> <select name="apimo_region" data-id="apimo_region" class="apimo_input apimo_filter_input apimo_input_select">
                                                                    ...
                                                                    <option value=""><?php _e('Select Region', 'apimo') ?></option> <?php $terms_region = $terms = get_terms(array('taxonomy' => 'region', 'hide_empty' => false)); foreach ($terms_region as $term_region): ?> <option value="<?php echo esc_attr($term_region->term_id); ?>"><?php echo esc_attr($term_region->name); ?></option> <?php endforeach; ?>
                                                            ...
                                                            <div class="apimo_location_wrap"> <label class="apimo-archive-filter"> <?php _e('City', 'apimo') ?> </label> <select name="apimo_city" data-id="apimo_city" class="apimo_input apimo_filter_input apimo_input_select">
                                                                    ...
                                                                    <option value=""><?php _e('Select City', 'apimo') ?></option> <?php $terms_region = $terms = get_terms(array('taxonomy' => 'city', 'hide_empty' => false, 'parent' => 0)); foreach ($terms_region as $term_region): ?> <option value="<?php echo esc_attr($term_region->term_id); ?>"><?php echo esc_attr($term_region->name); ?></option> <?php endforeach; ?>
                                                            ...
                                                            <div class="apimo_location_wrap"> <label class="apimo-archive-filter"> <?php _e('District', 'apimo') ?> </label> <select name="apimo_district" data-id="apimo_district" class="apimo_input apimo_filter_input apimo_input_select">
                                                                    ...
                                                                    <option value=""><?php _e('Select District', 'apimo') ?></option> <?php $terms_region = get_terms(array('taxonomy' => 'district', 'hide_empty' => false)); foreach ($terms_region as $term_region): ?> <option value="<?php echo esc_attr($term_region->term_id); ?>"><?php echo esc_attr($term_region->name); ?></option> <?php endforeach; ?>
                                                    ...
                                                    <div class="apimo-filter-product-shortcode-filter-input-container-accordion">
                                                    ...
                                                    </div> <?php /***taxonomy***/$array_of_taxonomy = array('apimo_property_standing' => __('Standing', 'apimo'), 'apimo_property_condition' => __('Condition', 'apimo'), 'apimo_heating_access' => __('Heating Access', 'apimo')); foreach ($array_of_taxonomy as $tax => $label): ?> <div class="apimo-filter-product-shortcode-filter-input-container-accordion">
                                                        ...
                                                        echo esc_attr($label); ?></option> <?php $terms_region = get_terms(array('taxonomy' => $tax, 'hide_empty' => false)); foreach ($terms_region as $term_region): ?> <option value="<?php echo esc_attr($term_region->term_id); ?>"><?php echo esc_attr($term_region->name); ?></option> <?php endforeach; ?>

                                                                </select> </div>

                                                        </div> <?php endforeach; ?> <?php /***taxonomy***//**metabox**/$array_of_metaboxes = array('apimo_bedrooms' => array('label' => __('Bedrooms', 'apimo'), 'type' => 'number'), 'apimo_construction_year' => array('label' => __('Construction Year', 'apimo'), 'type' => 'multiselectyear'), 'apimo_renovation_year' => array('label' => __('Renovation Year', 'apimo'), 'type' => 'multiselectyear'), 'apimo_price_hide' => array('label' => __('Price Hide', 'apimo'), 'type' => 'toggle'), 'apimo_residence_fees' => array('label' => __('Price Residence Range', 'apimo'), 'type' => 'range')); foreach ($array_of_metaboxes as $meta_key => $meta_data): ?> <div class="apimo-filter-product-shortcode-filter-input-container-accordion">
                            ...
                            <div class="apimo-step-buttons"> <button type="button" class="button apimo-step-button apimo-step-previous" data-id="2">Previous</button> <button type="button" class="button button-primary apimo-step-button apimo-step-next" data-id="4">Next</button> </div>
                        ...
                        <div class="apimo-step step-4" data-id="4">
                            ...
                            <div class="apimo-step-description">
                                ...
                                <div class="apimo-radiogroup"> <label class="apimo-type-radio">
                                        ...
                                        <div class="apimo-radio-container"> <input type="radio" name="step[step_2][template]" value="template_1" id="apimo-template-1"> <label for="apimo-template-1"><?php _e('Horizontal', 'apimo'); ?> <div class="apimo-radio-image"> <img src="<?php echo esc_url($apimo_url . 'assets/images/Horizzontal.png'); ?>"> </div> </label> </div>

                                    </label> <label class="apimo-type-radio">

                                        <div class="apimo-radio-container"> <input type="radio" name="step[step_2][template]" value="template_2" id="apimo-template-2"> <label for="apimo-template-2"><?php _e('Vertical', 'apimo'); ?> <div class="apimo-radio-image"> <img src="<?php echo esc_url($apimo_url . 'assets/images/Vertical.png'); ?>"> </div> </label> </div>

                                    </label> </div>

                            </div>

                            <div class="apimo-step-buttons"> <button type="button" class="button apimo-step-button apimo-step-previous" data-id="3">Previous</button> <button type="button" class="button button-primary apimo-step-button apimo-step-next" data-id="5">Next</button> </div>
                        ...
                        <div class="apimo-step step-5" data-id="5">
                            ...
                            <div class="apimo-step-title-inner">
                                ...
                                <p><?php _e('Choose how your properties are displayed:'); ?>
                            ...
                            <div class="apimo-step-description">
                                ...
                                <div class="apimo-radiogroup"> <label class="apimo-type-radio radio-flex">
                                        ...
                                        <div class="apimo-radio-container"> <input type="radio" name="apimo_shortcode_view_type" value="carousel" id="apimo-view-2"> <label for="apimo-view-2"><?php _e('Carousel', 'apimo'); ?> <div class="apimo-radio-image"> <img src="<?php echo esc_url($apimo_url . 'assets/images/Carousel.png'); ?>"> </div> </label> </div>
                            ...
                            <div class="apimo-step-buttons"> <button type="button" class="button apimo-step-button apimo-step-previous" data-id="4">Previous</button> <button type="button" class="button button-primary apimo-step-button apimo-step-next" data-id="6">Next</button> </div>
                        ...
                        <div class="apimo-step step-6" data-id="6">
                            ...
                            <div class="apimo-step-title-inner">
                                ...
                                <p><?php _e('Click on the "Generate now" button and copy the shortcode to a page on your website.'); ?>
                            ...
                            <div class="apimo-step-desctiption-content step-shortcode-end">
                                ...
                                <div class="apimo-shortcode"> <input type="text" name="shortcode" value="[apimo]" /> <input type="button" class="button" name="copy_shortcode" value="<?php _e('Copy', 'apimo'); ?>" /> </div>

                            </div>

                            <div class="apimo-step-buttons"> <button type="button" class="button apimo-step-button apimo-step-previous" data-id="5">Prev</button> </div>
