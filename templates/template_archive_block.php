...
<div class="apimo-properties-item Product-block">
    ...
    <div class="Pro-Image">
        ...
        elseif ($apimo_archive_settings['gallery_display_slider'] == 1) :
            ...
            <div class="apimo-propery-images-archive apimo-display apimo-slider-image-<?php /*echo count($gallery_images); */ if(is_array($gallery_images) || is_object($gallery_images)){echo count($gallery_images);} ?>">
    ...
    <a class="Pro-content" href="<?php echo get_permalink(); ?>">
        ...
        <div class="Pro-price Flex-col space-between">
            ...
            <?php else : ?>
                ...
                <span><?php if ($metas['apimo_price'][0]) {
