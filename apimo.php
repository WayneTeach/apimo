                        ...
                        <div class='params'>
                            ...
                            <label>
                                ...
                                <label>
                                    ...
                                    <input type="radio" name="template_type" id="template_1" value="template_1" <?php if ($update->parameters == 'template_1') { echo 'checked'; } ?>>
                                ...
                                <label>
                                    ...
                                    <input id="template_2" type="radio" name="template_type" value="template_2" <?php if ($update->parameters == 'template_2') {echo 'checked';} ?>>
...
function apimo_currency_format($amout)

{
    ...
    //return str_replace(',00', '', numfmt_format_currency($fmt, $amout, "EUR"));

    return '€ '.str_replace(',00', '', number_format((float)$amout, 2, ',', '.'));
